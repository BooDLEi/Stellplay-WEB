...
class MobilePlayer {
    constructor() {
        ...
        // PWA & 모바일 웹앱 백그라운드 재생 및 잠금화면 유지를 위한 무음 오디오 킵얼라이브 (15초 PCM 무음 루프)
        function createLongSilentAudioBlob() {
            try {
                const sampleRate = 8000;
                const numSamples = sampleRate * 15;
        ...
        this.silentAudio.src = createLongSilentAudioBlob();
